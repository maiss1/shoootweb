 ...
 */
final class Version20220412035359 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competition CHANGE type type VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE joueur CHANGE nom_equipe nom_equipe VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE stat_joueur CHANGE nom_joueur nom_joueur VARCHAR(255) NOT NULL, CHANGE nom_comp nom_comp VARCHAR(255) NOT NULL, CHANGE but_comp but_comp INT DEFAULT 0, CHANGE assist_comp assist_comp INT DEFAULT 0, CHANGE but_total but_total INT DEFAULT 0 NOT NULL, CHANGE assist_total assist_total INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE stats_comp CHANGE equipe equipe VARCHAR(255) NOT NULL, CHANGE competition competition VARCHAR(255) NOT NULL');
